...
const wsClient = new SubscriptionClient('wss://subscriptions.graph.cool/v1/cizr2bzgvbp4d0127v4nst0ac')

// __SIMPLE_API_ENDPOINT__ looks similar to: `https://api.graph.cool/simple/v1/<PROJECT_ID>`
const networkInterface = createNetworkInterface({
  uri: 'https://api.graph.cool/simple/v1/cizr2bzgvbp4d0127v4nst0ac',
})
